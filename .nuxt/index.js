...
import nuxt_plugin_pluginutils_4bf2430e from 'nuxt_plugin_pluginutils_4bf2430e' // Source: .\\nuxt-i18n\\plugin.utils.js (mode: 'all')
import nuxt_plugin_pluginrouting_29c9b184 from 'nuxt_plugin_pluginrouting_29c9b184' // Source: .\\nuxt-i18n\\plugin.routing.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"TG_ZAPAD","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_0a31c51c === 'function') {
    await nuxt_plugin_plugin_0a31c51c(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginutils_4bf2430e === 'function') {
    await nuxt_plugin_pluginutils_4bf2430e(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_29c9b184 === 'function') {
    await nuxt_plugin_pluginrouting_29c9b184(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_26a4486b === 'function') {
    await nuxt_plugin_pluginmain_26a4486b(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_4a59ac95 === 'function') {
    await nuxt_plugin_axios_4a59ac95(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_srcplugin67c3a475_fb01c750 === 'function') {
