     ...
     <div class="media-page">
         ...
         <div class="media-page-header-content">
           <div class="media-page-header-content-block">
             ...
             <div class="media-page-header-content-block-title">
               <p>Заложен фундамент здания музея Третьяковской галереи-Запад</p>
             </div>
           </div>
         </div>
       ...
       <div class="media-page-video">
         ...
         <div class="media-page-video-items">
           <div class="media-page-video-items-virtual-tour">
             <div></div>
             <div class="media-page-video-items-virtual-tour-content">
               <div class="img"></div>
             </div>
             <div class="media-page-video-items-virtual-tour-title">
               <p>04:33</p>
             </div>
           </div>
           <div class="media-page-video-items-virtual-tour">
