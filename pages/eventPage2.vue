     ...
     <div class="event-page">
       <div class="event-page-header">
         <div class="event-page-header-title">
           <p>
             ...
             <img class="mr-1" src="../assets/image/Vector135.svg" alt="">
             <span>назад</span>
             <img class="ml-1" src="../assets/image/).svg" alt="">
           </p>
         </div>
         <div class="event-page-header-content">
           <div class="event-page-header-content-block">
             ...
             <div class="event-page-header-content-block-title">
               <p>Крупнейшие мастера <span class="william">русского авангарда</span></p>
             </div>
         ...
         <div class="event-page-header-footer">
           <div class="event-page-header-footer-item">
             <div class="event-page-header-footer-item-block">
               <img class="mr-1" src="../assets/image/(.svg" alt="">
       ...
       <div class="event-page-content">
         <div class="event-page-content-buy-ticket">
           <div class="event-page-content-buy-ticket-date">
             <p>12 октября, 19 октября,26 октября, …</p>
           </div>
           <div class="event-page-content-buy-ticket-author">
             <img class="mr-1" src="../assets/image/infoOutline.svg" alt="">
             <p class="normal-case mb-4">Разовый билет можно приобрести в день проведения лекции в кассах Новой Третьяковки при наличии свободных мест</p>
           </div>
         </div>
         <div class="event-page-content-info">
           <div class="event-page-content-info-title">
             <p>XVIII век — переход от Средневековья к Новому времени. Русское искусство проходит путь освоения западноевропейского опыта. Зарождается светская культура.</p>
           </div>
           <div class="event-page-content-info-description">
           ...
           <div class="event-page-content-info-held">
             <div class="event-page-content-info-held-title">
               <p>ЗАнятия проводят</p>
             </div>
             <div class="event-page-content-info-held-items">
               ...
               <div class="flex items-center mt-4">
                 <img src="../assets/image/image44.jpg" alt="">
                 <div class="m-4">
                   <p>Кирилл Светляков</p>
       ...
       <div>
         <div class="events-content">
           <div class="events-content-block">
             ...
             <div class="events-content-block-items">
               <div class="events-content-block-item">
               ...
               <div class="events-content-block-item border-top">
                 <div class="events-content-block-item-image">
                   <img src="../assets/image/Pic-fit3.jpg" alt="">
                 </div>
                 <div class="events-content-block-item-body">
           ...
           <div class="events-content-block">
             <div class="events-content-block-text">
               <p class="events-content-block-text-day">Пятница, завтра</p>
               <p class="events-content-block-text-date">8 октября</p>
             </div>
             <div class="events-content-block-items">
               <div class="events-content-block-item">
                 <div class="events-content-block-item-image">
           ...
           <div class="events-content-block border-b border-current">
             <div class="events-content-block-text">
               <p class="events-content-block-text-day">Суббота</p>
               <p class="events-content-block-text-date">9 октября</p>
             </div>
             <div class="events-content-block-items">
               <div class="events-content-block-item">
                 <div class="events-content-block-item-image">
         ...
         <div class="events-content">
           ...
           <div class="events-content-block border-b mb-28 border-current">
             <div class="events-content-block-text">
               <p class="events-content-block-text-day">Суббота</p>
               <p class="events-content-block-text-date">9 октября</p>
             </div>
